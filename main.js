...
const swearWords = [`homo`,`fuk`,`bakla`,`shet`,`gago`,`tangina`,`puta`,`fuck`,`darn`,`shit`,`dick`,`asshole`,`bastard`,`bitch`,`damn`,`cunt`,`noob`];
...
bot.login("NTk2MDUwNjU0Nzk2MDU0NTQz.XRz5bg.QmChpl6KbVqQtyhIRqWUoGweDuQ").catch(O_o => {});